...
def dados_excel(cnpj, valor_total,volume_total, data_emissao, data_inicio, data_fim, numero_fatura, valor_icms, correcao_pcs, dist, arquivo):
    ...
    try:    
        ...
        dados = {
           ...
           'CORREÇÃO DO PCS': 'PCS não encontrado',
           'DISTRIBUIDORA': 'valor_total não econtrado',
...
pasta_pdfs = r'G:\QUALIDADE\Códigos\Leitura de Faturas Gás\Códigos\Gás Brasiliano\Faturas'

# Referência que queremos encontrar nos nomes dos arquivos
referencia = 'GASBRASILIANO'  # Exemplo: todos os arquivos que contêm 'FATURA' no nome
